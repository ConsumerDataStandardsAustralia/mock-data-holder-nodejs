...
DECLARE @DataHolderBaseUri NVARCHAR(450) = N'https://localhost:3005'
DECLARE @InfoSecBaseUri NVARCHAR(450) = N'https://localhost:8081'
...
'{"DataHolderBrandId": "' + @BrandId + '",
    ...
    "SoftwareStatement": "TrXrVNbp-zT-Uy3hOoOEXzYlqtzOrQ2dzsvp4N5AC0omy0rFihljTg",
